# TMF668 PartnershipTypeManagement
...
Once Node.js and npm are installed download and unzip the CTK-TMF668-PartnershipTypeManagement ZIP file within your test directory.
...
>http://tm-forum-open-api-reference-implementation.mybluemix.net:80/tmf-api/partnershipTypeManagement/v2/partnershipType

You should input:
>>http://tm-forum-open-api-reference-implementation.mybluemix.net:80/tmf-api/partnershipTypeManagement/v2/
...
![CTK Example Image](https://github.com/tmforum-rand/CTK-TMF668-PartnershipTypeManagement/blob/master/CTK-TMF668-PartnershipTypeManagement/Output-Example.png)
